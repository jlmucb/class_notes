...
bool FLAGS_printall = true;
string FLAGS_log_file("XXX_log_file");
...
int main(int an, char** av) {
  ...
  if (simpletest2()) {
    printf("simpletest2 succeeded\n");
  } else {
    printf("simpletest2 failed\n");
  }
  if (simpletest3()) {
    printf("simpletest3 succeeded\n");
  } else {
    printf("simpletest3 failed\n");
  }
  if (simpletest4()) {
    printf("simpletest4 succeeded\n");
  } else {
    printf("simpletest4 failed\n");
  }
  if (simpletimetest()) {
    printf("simpletimetest succeeded\n");
  } else {
    printf("simpletimetest failed\n");
  }
  if (conversiontests()) {
    printf("conversiontests succeeded\n");
  } else {
    printf("conversiontests failed\n");
  }
