...
class SymmetricKey : public CryptoKey {
 public:
  ...
  bool GenerateAesKey(const char* name, const char* usage, const char* owner,
                      int num_bits, double seconds_to_live);
  bool MakeAesKey(const char* name, const char* usage, const char* owner,
                  int num_bits, double secondstolive, byte* key);
  bool GenerateTwofishKey(const char* name, const char* usage,
                          const char* owner, int num_bits,
                          double seconds_to_live);
  bool MakeTwofishKey(const char* name, const char* usage, const char* owner,
                      int num_bits, double secondstolive, byte* key);
  bool GenerateRc4Key(const char* name, const char* usage, const char* owner,
                      int num_bits, double seconds_to_live);
  bool MakeRc4Key(const char* name, const char* usage, const char* owner,
                  int num_bits, double secondstolive, byte* key);

  bool GenerateSimonKey(const char* name, const char* usage, const char* owner,
                        int num_bits, double seconds_to_live);
  bool MakeSimonKey(const char* name, const char* usage, const char* owner,
                    int num_bits, double secondstolive, byte* key);

  bool GenerateTeaKey(const char* name, const char* usage, const char* owner,
                      int num_bits, double seconds_to_live);
  bool MakeTeaKey(const char* name, const char* usage, const char* owner,
                  int num_bits, double secondstolive, byte* key);
  bool ReadKey(string& filename);
  bool SaveKey(string& filename);
...
class RsaKey : public CryptoKey {
 public:
  ...
  bool GenerateRsaKey(const char* name, const char* usage, const char* owner,
                      int num_bits, double seconds_to_live);
  bool MakeRsaKey(const char* name, const char* usage, const char* owner,
                  int num_bits, double secondstolive, BigNum& m, BigNum& e,
                  BigNum& p, BigNum& q);
...
class EccKey : public CryptoKey {
 public:
  ...
  bool Encrypt(int size, byte* plain, BigNum& k, CurvePoint& pt1,
               CurvePoint& pt2);
