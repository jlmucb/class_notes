...
#    File: filecrawler.mak


SRC_DIR=$(HOME)/jlm/MySrc/art
...
O= $(OBJ_DIR)/art
INCLUDE= -I$(HOME)/src/github.com/jlmucb/crypto/include
...
$(O)/filecrawl.o: $(SRC_DIR)/filecrawl.cc
	...
	$(CC) $(CFLAGS) $(INCLUDE) -c -o $(O)/filecrawl.o $(SRC_DIR)/filecrawl.cc
