...
$(EXE_DIR)/mbm23.exe: $(dobj) 
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/mbm23.exe $(dobj) $(LDFLAGS)
 
$(O)/mbm23.o: $(SRC_DIR)/mbm23.cc
	@echo "compiling mbm23.cc"
	$(CC) $(CFLAGS) -c -o $(O)/mbm23.o $(SRC_DIR)/mbm23.cc
