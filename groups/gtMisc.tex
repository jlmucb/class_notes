...
\emph{Proof:}
\end{quote}
{\bf Theorem 16:} $P \in S_P(G)$, $N_G(P) \subseteq M$, $M$, maximal, then $|G:M|=1 \jmod{p}$.
\begin{quote}
\emph{Proof:}
\end{quote}
{\bf Theorem 17:} If $p$ is the smallest prime dividing $|G|$, $P \in S_p(G)$ and $P$ is cyclic, $N_G(P)=C_G(P)$.
\begin{quote}
\emph{Proof:}
\end{quote}
