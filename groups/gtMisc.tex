...
\emph{Proof:}
\end{quote}
{\bf Theorem 11:} If $P,R$ are chosen with $|P \cap R|$ maximal, $N_G(P \cap R)$ is not a $p$-group.
\begin{quote}
\emph{Proof:}
\end{quote}
...
\\
\\
{\bf Lemma 3:} $G$ has no element of orger $21$.
\\
\\
{\bf Lemma 4:} $R \in S_3(G)$,  $n_3=|G:N_G(R)|=28$
\\
\\
{\bf Lemma 5:} $V \subseteq G$, $V$ a Klein $4$-group with $N_G(V)=S_4$.
\\
\\
