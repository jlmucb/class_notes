...
(2) $\exists s:Q \rightarrow G$, a monomophism, such that $\varphi \cdot s = id_Q$;
(3) $G$ is a semidirect product of $N$ by $H$ written $H \ltimes N$; in this
...
\gamma_n(x_n))$.
\end{quote}
{\bf Construction:} Consider $H,K$ with $Z_1 \subseteq {\mathbb Z}(H)$ and $Z_2 \subseteq {\mathbb Z}(K)$.  Let
$\theta: Z_1 \rightarrow Z_2$ be an isomorphism.  The central product (with $Z_1$ identified with $Z_2$) is $(H \times K) / X$,
where $X = \{(z, \theta^{-1}(z)), z \in Z_1 \}$.
\\
\\
{\bf Example:}
Let $D_1 \sim D_8= \{\rho_1, \tau_1 \}$, ${\rho_1}^4 = {\tau_1}^2 = 1$ and
$D_2 \sim D_8= \{\rho_2, \tau_2 \}$, ${\rho_2}^4 = {\tau_2}^2 = 1$.  Consider the
central product $G= D_1 * D_2$ with
$Z_1 = \langle {\rho_1}^2 \rangle$ and $Z_2 = \langle {\rho_2}^2 \rangle$. Now, in $G$,
put $Q_1 = \langle \rho_1, \tau_1 \rho_2 \rangle$ and
$Q_2 = \langle \rho_1 \tau_2, \rho_2 \rangle$.  $Q_1$ and $Q_2$ are both quaternion and
$G=D_1*D_2=Q_1*Q_2$.
\\
\\
{\bf Theorem 6:}
