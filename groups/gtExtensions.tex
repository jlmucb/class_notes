...
{\bf Data:} $(K,Q,\theta)$, $K$, abelian, $\theta: Q \rightarrow Aut(K)$, for every transversal $l: Q \rightarrow G$.
...
\emph{Projective lifting property}. If $Q$ is a finite group $U$ is a \emph{cover} of $Q$
