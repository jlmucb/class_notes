...
with no non-trivial normal subgroup of order prine to $p$ then $C_K(O_p(K)) = {\mathbb Z}(O_p(K))$ and so $C_k(O_p(K)) \leq O_p(K)$.  This
yields ${\overline {B_1}} = 1$ and thus $|{\overline A}| = |A:A \cap O_p(K)|= p$. Put $B = A \cap O_p(K)$.  $B$  is a hyperplane of $A$.
Choose $a \in A \setminus B$.  Then $A = \langle a \rangle \times B$
...
abelian $2^c=p+1 \mid |{\hat N}|$. ${\hat N}$ is a 2-group. $m({\hat N}) \geq c$
