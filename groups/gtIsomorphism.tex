...
\\
{\bf Definition 5:}
A \emph{chief factor}, $H/K$ of $G$: $H \lhd G$ and $K \lhd G$: $H/K$ is a minimal normal subgroup of $G/K$.
A \emph{chief series} is a normal series with no repeated terms and no normal subgroup properly
lying between two series elements [i.e. - $N_i/N_{i-1}$ is a chief factor].  Chief factors are
characteristically simple. $1 \leq K_4 \leq A_4 \leq S_4$ is a chief series.  Also note that
$N_i \lhd G$.
\\
\\
{\bf Definition 6:}
